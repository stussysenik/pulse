...
config :pulse, PulseWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "IZhToCK4rdtjTLbVee+SAralnX8GUMqAvkOB0IDhIKJHvHgO//0bCMgxaQgIwDZb",
  watchers: [
...
config :pulse, PulseWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/pulse_web/router\.ex$"E,
      ~r"lib/pulse_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
